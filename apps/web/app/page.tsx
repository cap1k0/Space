      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        ...
        <section className="mb-16 max-w-2xl">
          ...
          <p className="mb-6 text-base leading-relaxed text-neutral-600">
            Bruca is a language model trained on the gap between professional
            editors and AI-generated edits in scholarly writing. The result
            is an agent that edits like a copyeditor, not a rewriter.
          </p>
